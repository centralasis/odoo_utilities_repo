...
class PosOrderLine(models.Model):
    ...
    settled_order_id = fields.Many2one(
        'pos.order', string='Settled Order', index='btree_not_null')
    settled_invoice_id = fields.Many2one(
        'account.move', string='Settled Invoice', index='btree_not_null')
